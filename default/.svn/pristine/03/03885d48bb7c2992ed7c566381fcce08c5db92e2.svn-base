...
public class DifferenceCreationDialog extends JDialog{
	...
	private void buildLayout(){
		...
		top.setBackground(Util.lightBlue);
		...
		bot.setBackground(Util.lightBlue);
		bot.add(addBtn);
	...
	private AbstractAction addAct = new AbstractAction("Create Difference".toUpperCase()) {
		public void actionPerformed(ActionEvent e) {
			if(checkInputValidity()){
				...
				JOptionPane.showMessageDialog(DifferenceCreationDialog.this, 
						"Invalid entry for dielectric constant.\n"
