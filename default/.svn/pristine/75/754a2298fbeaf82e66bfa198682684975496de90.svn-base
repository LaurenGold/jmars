...
public class OutLine implements GLRenderable, Disposable {
	 ...
	 * @param scale floating point value for elevating the outline above the surface of the body to prevent interference. 1.005 is typical, 1.0 is minimum
	 */
	public OutLine(int idNumber, float[] points, float[] lineColor, int lineWidth, float scale, boolean closedLoop) {
	 ...
	 * @param scale floating point value for elevating the outline above the surface of the body to prevent interference. 1.005 is typical, 1.0 is minimum
	 */
	public OutLine(int idNumber, float[] points, float[] lineColor, int lineWidth, float scale, boolean closedLoop, boolean onBody) {
	 ...
	 */
	public OutLine(int idNumber, float[] points, float[] lineColor, int lineWidth, float scale, boolean closedLoop, short dashPattern, int multFactor) {
	 ...
	 */
	public OutLine(int idNumber, float[] points, float[] lineColor, int lineWidth, float scale, boolean closedLoop, short dashPattern, int multFactor, boolean onBody) {
