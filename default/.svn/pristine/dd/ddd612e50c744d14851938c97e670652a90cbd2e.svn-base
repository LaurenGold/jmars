            ...
            try { 
                ...
                switch (httpCode) {
                    ...
                    case HttpStatus.SC_PROXY_AUTHENTICATION_REQUIRED:
                        this.log.aprintln("JmarsHttpRequest: Need to specfy proxy password/username");
                ...
                if (e instanceof HttpHostConnectException ||
                    ...
                    this.log.aprintln("JmarsHttpRequest: Connection refused by server: "+e.toString());
                    this.httpCode = HttpStatus.SC_INTERNAL_SERVER_ERROR;
                    displayProxyInfoDialog();

                } else if (e instanceof SocketTimeoutException) {
                    this.log.aprintln("JmarsHttpRequest: An unexpected exception was thrown: "+e.getMessage());
                    this.log.aprintln("Exception name:"+e.toString());
                ...
                if (httpClient != null) {
                    try {
                        ...
                        this.log.aprintln("JmarsHttpRequest: got an IOException-- couldn't close the client.");
                    }
                }
            } // catch
