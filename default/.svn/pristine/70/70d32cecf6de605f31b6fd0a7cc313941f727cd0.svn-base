...
public final class FPath {
	...
	public FPath (Shape shape, int coordSystem) {
		...
		// ensure WORLD coordinate shapes are normalized - unless the entire shape is wider than 180,
		// in which case this routine makes it worse.
		if (shape.getBounds2D().getWidth()<180) {
	 ...
	 * @param po  ProjObj to convert from spatial to wrold
