...
//    private Thread processThread = null;
    ...
    private void initComponents() {
        ...
        setPreferredSize(new Dimension(700, 575));
        ...
        mainTp.addTab("UPLOAD", uploadTabPanel);
    ...
    private void buildMainDialog() {
        ...
        Dimension d1 = new Dimension(800, 450);
...
//        manageMapsTabPanel = new JPanel();
    ...
    private void buildSharingManagementDialog() {
        ...
        manageGroupsDialog.setSize(new Dimension(513, 508));
