...
public class LandingSiteTable extends STable 
{
	...
	Color disabled = UIManager.getColor("Table.background");
	...
	private class MultiLineCellRenderer extends DefaultTableCellRenderer {
				...
				int row, int column) 
		{
			...
			if(isSelected){
				...
				this.setBackground(LandingSiteTable.this.disabled);
			}			
			if(value == null){
...
class NoteCellEditor extends AbstractCellEditor implements TableCellEditor{
	...
	public Component getTableCellEditorComponent(JTable table, Object value,
		...
		int ok = JOptionPane.showConfirmDialog(table, sp, "Enter Note", JOptionPane.OK_CANCEL_OPTION);
