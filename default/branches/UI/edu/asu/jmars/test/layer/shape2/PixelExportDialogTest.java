...
public class PixelExportDialogTest {
	...
	public void testSaveCSV() throws Exception{
		...
		PixelExportDialog ped = new PixelExportDialog(null, null, paths);
		
		ped.saveCSV(idBool, latBool, lonBool, nullBool, sources, ppd, paths, writer);
		...
		ped = new PixelExportDialog(null, null, paths);
