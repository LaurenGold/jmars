...
public class Row extends JPanel {
	...
	public Row(final Layer.LView view, MouseInputListener rowMouseHandler) {
		...
		this.defaultLED = view.getLayer().getStatus();
		this.parent = this;
	}
	...
	public void createGUI() {
		...
		maplabel = new JLabel(" " + LManager.getLManager().getUniqueName(view));		
		...
		rowpopup = new RowQuickAccessPopup(view);
		    ...
		    rowgroup.createSequentialGroup()
	            ...
	            .addGroup(rowgroup.createParallelGroup(Alignment.LEADING)
	                .addGroup(rowgroup.createSequentialGroup()
	                        .addComponent(maplabel, labelWidth,labelWidth,Short.MAX_VALUE)
	...
	public void setText(String newText) {		
		...
		maplabel.setToolTipText(newText);
	}
