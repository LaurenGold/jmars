		...
		Runnable runme = new Runnable() {
			...
			public void run() {
				...
				{       
					...
					JOptionPane.showMessageDialog(viewToUpdate.wrapper.getContainer(),
							msg,
							"Query Result",
							JOptionPane.INFORMATION_MESSAGE
					);
					...
					if (!dialog.isCanceled()) {
						...
						if (spectraData() && newColumnClasses.length>0) {
							Class[] expandedColumnClasses = new Class[newColumnClasses.length+4];
							String[] expandedColumnNames = new String[newColumnNames.length+4];
							...
							expandedColumnClasses[expandedColumnClasses.length-4]=Boolean.class;
							...
							expandedColumnNames[expandedColumnNames.length-4]="Hide";
							...
							public void run() {
								...
								if (viewToUpdate!=null) {
									...
									if(viewToUpdate.getLView3D().isEnabled()){
										...
										if(mgr.isReady() && viewToUpdate.getLView3D().isVisible()){
