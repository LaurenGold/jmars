...
//	    new GroundTrackLayer.Request(67011580, 67018740, 20);
    ...
    public GroundTrackLView(GroundTrackFactory.LayerParams pars)
     {
	super(pars.getLayer());
	...
	*/
	...
	try
	...
	catch(IllegalArgumentException ex)
	 {
		...
		"Unable to re-center at that point!");
	    return  null;
	 }
     }
    ...
    public Layer.LView _new()
     {
	return	new GroundTrackLView(currLayerPars);
     }

    public static void main(String[] av)
     {
	MyFocus myFocus =
	    new GroundTrackLView(GroundTrackFactory.SPACECRAFT[0])
	    .new MyFocus();
	...
	public void actionPerformed(ActionEvent e)
	 {
		...
		if(delta == null)
	     ...
	     {
		JOptionPane.showMessageDialog(this, ex, "INVALID TIME",
