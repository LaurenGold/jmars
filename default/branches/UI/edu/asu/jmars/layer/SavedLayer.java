...
public class SavedLayer implements Serializable {
	...
	public SavedLayer(String factoryName, String layerName, SerializedParameters createParms, Hashtable<?,?> viewParms, float alpha, boolean showMain, boolean showPanner) {
